exports.contactEmail = (name, email, phone, subject, message) => {
  return {
    Source: `Contact Form <${process.env.EMAIL_FROM}>`, 
    Destination: { 
                                          ...
                                          <td class="pc-sm-p-24-20-30 pc-xs-p-15-10-20" valign="top" style="padding: 24px 30px 40px;">
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                              <tbody>
                                                ...
                                                <tr>
                                                  <td class="pc-xs-fs-30 pc-xs-lh-42 pc-fb-font pc-xs-br-disabled" valign="top" style="padding: 13px 10px 0; letter-spacing: -0.7px; line-height: 46px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 32px; font-weight: 800; color: #ffffff">
                                                    <div style="background-color: rgba(104, 104, 104, .4); padding: 15px 30px; border-radius: 20px;">${name}, sent you message</div>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
